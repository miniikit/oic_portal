...
@section('main')
    ...
    <div class="row_content">
        <form role="form" id="register_form" class="col s12" method="POST" action="{{ url('/register/complete') }}"
            ...
            <div class="icon-box file-field input-field col s12 center">
                <div class="imgInput">
                    ...
                    <a class="edit-btn btn-floating waves-effect waves-light green" name="profile_image"><i
                                class="material-icons">edit</i><input type="file" name="profile_image"></a>
                    <p>※ 拡張子: jpg png</p>
                </div><!--/.imgInput-->
            </div>

            <div class="input-field col s12">
                <input id="profile_name" type="text" class="val-red validate" name="profile_name"
                       value="{{ old('profile_name') }}" required="required">
            ...
            <div class="input-field col s12">
                <input id="email" type="email" class="validate" disabled="disabled" name="email"
                       value="{{ $getUser->email }}" required="required">
            ...
            <div class="input-field col s12">
                <input id="portfolio" name="profile_url" type="text" class="validate" value="{{ old('profile_url') }}"
                       placeholder="（例）https://github.com/　　※任意">
                <label for="portfolio">ポートフォリオ</label>
            </div>

            <div class="input-field col s12">
                <textarea id="introduction" name="profile_introduction" class="materialize-textarea"
                          value="{{ old('profile_introduction') }}"></textarea>
                <label for="introduction">自己紹介</label>
            </div>

            <div class="row">
                <div class="col s6 center-align">
                    <button type="button" class="back-btn waves-effect waves-light btn" onclick="history.back()">戻る
                    </button>
                </div>
                <div class="col s6 center-align">
